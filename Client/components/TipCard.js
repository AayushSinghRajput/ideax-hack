          ...
          >
            <View style={styles.cardContent}>
              ...
              <Text style={styles.desc} numberOfLines={2}>
                {language === "EN"
                  ? tip.description
                  : tip.descriptionNP || tip.description}
              </Text>
                ...
                <>
                  <View style={styles.tipHeader}>
                    <Text style={styles.tipTitle}>
                      {language === "EN"
                        ? selectedTip.title
                        : selectedTip.titleNP || selectedTip.title}
                    </Text>
                    <View style={styles.tipMeta}>
                      <View style={styles.metaItem}>
                        ...
                        <Text style={styles.metaText}>
                          {language === "EN"
                            ? selectedTip.date
                            : selectedTip.dateNP || selectedTip.date}
                        </Text>
                      </View>
                      {selectedTip.category && (
                        <View style={styles.categoryBadge}>
                          <Text style={styles.categoryText}>
                            {language === "EN"
                              ? selectedTip.category
                              : selectedTip.categoryNP || selectedTip.category}
                          </Text>
                        </View>
                      )}
                    </View>
                  ...
                  <View style={styles.descriptionContainer}>
                    <Text style={styles.fullDescription}>
                      {selectedTip.id === "1"
                        ...
                        : selectedTip.descriptionNP || selectedTip.description}
                    </Text>
                  </View>
                  ...
                  <View style={styles.sourceContainer}>
                    ...
                    <Text style={styles.sourceText}>
                      {selectedTip.id === "1"
                        ...
                        : language === "EN"
                        ? "Monsoon Farming Guide 2024"
                        : "मनसुन कृषि गाइड २०२४"}
                    </Text>
                  </View>
                </>
              )}
